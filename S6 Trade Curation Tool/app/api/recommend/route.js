...
// âââ Stage 1: Claude parses the brief into structured data ââââââââââââââââââââ
async function parseBriefWithClaude(text) {
  ...
  const message = await client.messages.create({
    ...
    messages: [{
      role: 'user',
      content: `You are an interior design trade art curation assistant. Parse this Jotform curation brief into structured JSON. The brief may be in any format â a direct form response, a copied email, a freeform description, or a structured list.
...
// âââ Stage 2: Claude selects the best artworks from candidates ââââââââââââââââ
...
// âââ Regex Brief Parser (fallback when no API key) ââââââââââââââââââââââââââââ
...
// âââ Catalog tagging (for keyword pre-filter) âââââââââââââââââââââââââââââââââ
...
// âââ Keyword pre-filter scoring (gets candidates for Claude to pick from) ââââââ
...
export async function POST(request) {
  try {
    ...
    // ââ Parse brief âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    let brief;
    if (hasAnthropicKey) {
      try {
    ...
    // ââ Keyword pre-filter: get top candidates for Claude to choose from ââââââ
    ...
    // ââ Stage 2: Claude selects the actual artworks âââââââââââââââââââââââââââ
    let primary = [];
    let accent  = [];
    ...
    // ââ Pinned items (force-include specific Society6 URLs) âââââââââââââââââââ
    const pinnedRecords = [];
    ...
    // ââ Gallery wall sets âââââââââââââââââââââââââââââââââââââââââââââââââââââ
